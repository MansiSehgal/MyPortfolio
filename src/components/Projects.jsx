...
const ProjectCard = ({
  ...
  return (
    <Zoom>
      <Tilt
        options={{ max: 20 }}
        className="bg-tertiary p-5 rounded-2xl w-full sm:w-[360px] h-[600px]"
      >
        <a href={hosted_link} className="cursor-pointer" target="_blank">
          ...
          <div className="mt-5 h-[250px] overflow-y-scroll">
...
const Projects = () => {
  return (
    <div>
      ...
      <p className="text-secondary max-w-3xl text-[16px] mt-3 leading-[30px] h-[250px]">
        {projectsDescription}
      </p>
