    ...
    <section className="flex sm:flex-row flex-col w-full justify-between gap-[40px] sm:py-[15%] py-[40%] h-[90vh] mx-auto ">
          ...
          <div className="flex flex-row gap-8">
            ...
            <div>
              <h1 className={`${styles.heroHeadText}`}>
                Hi I'm <span className="text-[#915eff]">Mansi</span>
              </h1>
      ...
      <ZoomAwesome down cascade>
        <div className="flex sm:flex-col flex-row items center mr-[20px]">
          ...
          >
            <a href="https://www.instagram.com/mansisehgal165/" target="_blank">
              <img src={instagram} />
            </a>
          </Tilt>
          <Tilt
            ...
            className="m-[20px] cursor-pointer"
          >
            <a href="https://github.com/MansiSehgal/" target="_blank">
              <img src={githubSvg} />
            </a>
          </Tilt>
          ...
          >
            <a
              href="https://www.linkedin.com/in/mansisehgal165/"
              target="_blank"
            >
              <img src={linkedin} />
            </a>
